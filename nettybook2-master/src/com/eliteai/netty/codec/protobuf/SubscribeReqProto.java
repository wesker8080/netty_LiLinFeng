...
public final class SubscribeReqProto {
  ...
  public interface SubscribeReqOrBuilder extends
    ...
    /**
     * <code>required string producName = 3;</code>
     */
    boolean hasProducName();
    /**
     * <code>required string producName = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PRODUCNAME_FIELD_NUMBER = 3;
    private volatile Object producName_;
    /**
     * <code>required string producName = 3;</code>
     */
    public boolean hasProducName() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 3, producName_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(3, producName_);
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
    ...
    public boolean equals(final Object obj) {
      ...
      result = result && (hasProducName() == other.hasProducName());
      if (hasProducName()) {
        result = result && getProducName()
            .equals(other.getProducName());
      }
    ...
    public int hashCode() {
      ...
      if (hasProducName()) {
        hash = (37 * hash) + PRODUCNAME_FIELD_NUMBER;
        hash = (53 * hash) + getProducName().hashCode();
      }
      if (hasAddress()) {
    ...
    public static final class Builder extends
      ...
      // Construct using com.eliteai.netty.codec.protobuf.SubscribeReqProto.SubscribeReq.newBuilder()
      private Builder() {
      ...
      public SubscribeReq buildPartial() {
        ...
        result.producName_ = producName_;
      ...
      public Builder mergeFrom(SubscribeReq other) {
        ...
        if (other.hasProducName()) {
          bitField0_ |= 0x00000004;
          producName_ = other.producName_;
          onChanged();
        }
        if (other.hasAddress()) {
          bitField0_ |= 0x00000008;
  ...
  bitField0_ |= 0x00000004;
       ...
       * <code>required string producName = 3;</code>
       */
      public Builder clearProducName() {
        bitField0_ = (bitField0_ & ~0x00000004);
        producName_ = getDefaultInstance().getProducName();
        onChanged();
        return this;
      }
      /**
       * <code>required string producName = 3;</code>
       */
      public Builder setProducNameBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ...
  static {
    String[] descriptorData = {
      "\n\022SubscribeReq.proto\022\005netty\"W\n\014Subscribe" +
      "Req\022\020\n\010subReqID\030\001 \002(\005\022\020\n\010userName\030\002 \002(\t\022" +
      "\022\n\nproducName\030\003 \002(\t\022\017\n\007address\030\004 \002(\tB5\n " +
      "com.eliteai.netty.codec.protobufB\021Subscr" +
      "ibeReqProto"
    };
    ...
    internal_static_netty_SubscribeReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_netty_SubscribeReq_descriptor,
        new String[] { "SubReqID", "UserName", "ProducName", "Address", });
  }
